                ...
                <div className="card-actions items-center relative">
                    ...
                    >
                        <div className='flex flex-col ml-auto items-end pr-6'>
                                <span
                                    className="text-sm font-medium text-slate-300">Price per day:</span>
    ...
    return (
      ...
      <span>
        ...
        Incomplete Car Details
            ...
            This car is not ready to be listed for rental. Please complete all required fields to make it available for
            customers.
            <button className="btn btn-outline btn-sm text-error-content">Complete Details</button>
        </div>
    );
}
