...
export const metadata = {
    title: 'Completing Registration | Elite Rentals',
    description: 'Completing user registration. Please wait while your role is assigned within the Elite Rentals system.',
};
