...
export const metadata = {
    title: 'Privacy Policy | Elite Rentals',
};
    ...
    return (
        <>
            ...
            <main className="py-10 px-4 md:px-8 lg:px-14">
                <h1 className="text-4xl font-semibold">Elite Rentals - Privacy Policy</h1>

                <p>At Elite Rentals, we value your privacy and are committed to protecting your personal information. This privacy policy explains how we collect, use, share, and protect your data when you use our website and services.</p>
